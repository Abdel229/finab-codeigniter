        ...
        if (menuBtn) {
                ...
                <ul class="ui-dropdown__list">
                    <li class="ui-dropdown__list-item">
                        <button class="ui-dropdown__list-item-btn" >
                            ...
                            <a href="categories/update/${id}" class="" title="Modifier">
                                Modifier
                            </a>
                        </button>
                    </li>
                    <li class="ui-dropdown__list-item">
                        <button class="ui-dropdown__list-item-btn" data-action="barcode-control">
                            ...
                            <a href="categories/delete/${id}" class="" title="Supprimer">
                                Supprimer
                            </a>
                        </button>
                    </li>
            ...
            const dropdown = new Dropdown({
                ...
                callBack: (dropdown) => {
                    ...
                    //                 <h2 class="ui-modal__title">Modification de la catégorie d'article</h2>
                    //             </div>
