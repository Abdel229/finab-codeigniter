...
class User extends Model
{
    ...
    protected $allowedFields = ['last_name', 'first_names', 'country', 'whatsapp_number', 'profession', 'date_place_of_birth', 'home_residence', 'email', 'password', 'created_at', 'updated_at', 'role','statut'];
