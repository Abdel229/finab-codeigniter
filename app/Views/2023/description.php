<?php include('./commons/doc_header.php');?>
 ...
 <!---           
  <div class="all-page-title" style="background-image:url(img/carousel-2.png);">
...
--->
            ...
            <!-- Page Header Start -->
            <div class="page-header" style="background-image:url(img/descri6.png);">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 fact-right wow slideInRight">
                            <div class="about-img">
                                <img src="img/descri.jpg" alt="Image">
                            </div>
                        </div>
                        <div class="col-md-6 fact-left wow slideInLeft">
                            ...
                            <div class="about-text">
                                <p>
                                    Le Festival International des Arts du Bénin (FInAB) et son marché d’art dénommé « TOKP’ART » inspiré du marché « TOKPA », le plus grand marché de l’Afrique de l’Ouest est une initiative du GROUPE EMPIRE qui rassemblera tous lesdeux (2)ans enfévrier,lesoeuvres d’une centaine d’artistes / groupes d’artistes Béninois et internationaux, toutes disciplines confondues, choisis parmi de nombreux dossiers d’appels à candidature provenant de plusieurs pays.
                                </p>
                            </div>
                        </div>
                    </div>
					<div class="row align-items-center">
                        ...
                        <div class="col-md-6 fact-left wow slideInLeft">
                            ...
                            <div class="about-text">
                                <p>
                                    Seront également présents sur le FInAB, les acteurs culturels, les programmateurs,les acheteurs de spectacles, les partenaires, les touristes, etc. de plusieurs pays. Outre les nombreux artistes talentueux venant de divers horizons, le FInAB à chaque édition donnera un coup de projecteur sur un pays africain. Le premier pays invité pour cette édition est le Maroc. Cette invitation vise à développer le rapprochement des deux pays et de leurs cultures.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6 fact-right wow slideInRight">
                            <div class="about-img">
                                <img src="img/descri2.jpg" alt="Image">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 fact-left wow slideInLeft">
                            ...
                            <div class="about-img">
                                <img src="img/descri3.webp" alt="Image">
                            </div>
                       
                        </div>
                        <div class="col-md-6 fact-right wow slideInRight">
                            <div class="about-img">
                                <img src="img/descri4.jpg" alt="Image">
                            </div>
                        </div>
                    </div>
             ...
             <div class="about wow fadeInUp" data-wow-delay="">
                <div class="container">
                    <div class="row align-items-center">
                                <div class="col-md-6 fact-right wow slideInRight">
                                    <div class="about-img">
                                        <img src="img/cible.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-md-6 fact-left wow slideInLeft">
                                    <div class="section-header text-left">
                                    ...
                                    <div class="about-text">
                                        <p>
                                            Le Festival International des Arts Du Bénin (FInAB) s’adresse à tout public. Son coeur de cible étant les passionnés d’Arts, de la Culture friands de nouveautés, les artistes, les acteurs culturels du Bénin, de l’Afrique et du monde, les populations Béninoises, les touristes,l’audimat des chaînes.
                                        </p>
                                    </div>
                                </div>
                            </div>
