    ...
    <div class="dashboard">
        ...
        <div class="dashboard__right">
            ...
            <div class="dashboard__main">
                ...
                <form class="fnb-form" method="post" enctype="multipart/form-data" action="<?= base_url('contacts/adresse') ?>">
                        <div class="fnb-form__item">
                            <label for="title">Adresse</label>
                            <input type="input" id="title" name="adresse" value="<?= $contact? $contact['adresse']:''?>" required>
                        </div>
