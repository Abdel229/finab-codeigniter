            ...
            <div class="dashboard__main">
                ...
                <ul class="cpn-pg-menu">
                    ...
                    <li class="cpn-pg-menu__item">
                        <a href="<?=base_url('/others')?>" class="cpn-pg-menu__item-link "> <span>Logo</span></a>
                    </li>
                    <li class="cpn-pg-menu__item">
                        <a href="<?=base_url('/others/promotteur')?>" class="cpn-pg-menu__item-link ">
                            <span>Promotteur</span> 
                        </a>
                    </li>
                    <li class="cpn-pg-menu__item">
                        <a href="<?=base_url('/others/configuration')?>" class="cpn-pg-menu__item-link ">
