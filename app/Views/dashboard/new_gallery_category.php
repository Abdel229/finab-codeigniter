        ...
        <div class="dashboard__right">
            ...
            <div class="dashboard__main">
                ...
                <div class="dashboard__main__box">
                    <?= view('sections/error') ?>
                    <form class="article-form fnb-form" method="post" enctype="multipart/form-data" action="<?= base_url('gallery_categorie/store') ?>">
                        <div class="form-group">
                            <label for="title">Titre de la catégorie</label>
                            <input type="text" id="title" name="name" required>
                        </div>
                        <button type="submit" class="submit-button">Créer la catégorie</button>
                    </form>
