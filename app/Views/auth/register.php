...
<body>
    <div class="form-container">
        ...
        <form id="login-form" action="<?php echo base_url('/auth/register'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form__group">
                <label for="password" class='form__label'>Confirmez votre mot de passe :</label>
                <input type="password" id="password" name="password_confirm" class='form__input' required>
                <span class="error-message" id="password-error"></span>
            </div>
            <div class="form__group">
