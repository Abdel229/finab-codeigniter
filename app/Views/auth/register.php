...
<body>
    <div class="login-container">
        <?=view('sections/error')?>
        <h2>Inscription</h2>
        <form id="login-form" action="<?php echo base_url('/auth/register'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="password" class='loigin_label'>Confirmez votre mot de passe :</label>
                <input type="password" id="password" name="password_confirm" class='loigin_input' required>
                <span class="error-message" id="password-error"></span>
            </div>
            <div class="form-group">
